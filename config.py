...
#
# Milestone 4: my five in-corpus questions came back between 0.213 and 0.431.
# The five OUT_OF_SCOPE ones came back between 0.825 and 0.934. Nothing landed
# in between, so I put the cutoff in the middle of that gap.
THRESHOLD = 0.63
